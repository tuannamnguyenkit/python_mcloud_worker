...
#  Author  :  Hua Yu
#  Module  :  ngets.tcl
#  Date    :  $Id: ngets.tcl 3191 2010-03-13 09:22:19Z stueker $
#
...
proc cgets { file var_ } {
	...
	if {[file exists $file.$env(C_PROCESS).DONE]} {
	    ...
	    writeLog stderr "cgets: reading [llength $fgetsCACHE($file)] keys from '${file}\\${file}.$env(C_PROCESS)'"
	} else {
	    ...
	    writeLog stderr "cgets: reading \[$k1:$k2\] from '$file'"
	}
